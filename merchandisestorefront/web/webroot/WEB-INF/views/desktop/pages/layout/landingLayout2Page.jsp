...
<cms:pageSlot position="Section1" var="feature" element="div"
	...
	<div class="span-24 section2">
		<cms:pageSlot position="Section2A" var="feature" element="div"
			class="span-12 zone_c cms_disp-img_slot last customMargin">
			<cms:component component="${feature}" />
		</cms:pageSlot> 
	
		

		<cms:pageSlot position="Section2B" var="feature" element="div" class="span-12 zone_b thumbnail_detail ">
			<cms:component component="${feature}" />
		</cms:pageSlot>

		<cms:pageSlot position="Section2C" var="feature" element="div"
			class="span-12 zone_c cms_disp-img_slot last">
			<cms:component component="${feature}" element="div" />
		</cms:pageSlot>
	</div>
...
<%-- 	<cms:pageSlot position="Section4" var="feature" element="div"
	...
	<cms:pageSlot position="Section5" var="feature" element="div"
		class="span-24">
		<cms:component component="${feature}" element="div"
			class="span-12 section4 small_detail ${(elementPos%4 == 3) ? 'last' : ''}" />
	</cms:pageSlot>
	
	<%-- <cms:pageSlot position="Section5" var="feature" element="div"
		class="span-24">
		<cms:component component="${feature}" class="span-12 section4 small_detail"/>
	</cms:pageSlot> --%>
